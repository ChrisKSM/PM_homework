...
echo ""
echo "=== import 테스트 ==="
python3 -c "from services import sprint_plan_service; from routers import sprint_plan; print('OK', sprint_plan.router.prefix, hasattr(sprint_plan_service, 'get_sprint_plan_forecast'))" 2>/dev/null \
  || python -c "from services import sprint_plan_service; from routers import sprint_plan; print('OK', sprint_plan.router.prefix, hasattr(sprint_plan_service, 'get_sprint_plan_forecast'))"
